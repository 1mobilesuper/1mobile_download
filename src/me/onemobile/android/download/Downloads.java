...
public final class Downloads {
     ...
     * @hide
     */
    public static final Uri get_CONTENT_URI(Context ctx) {
       return Uri.parse("content://" + DownloadProvider.getAuth(ctx) + "/my_downloads");
    }
     ...
     */
    public static final Uri get_ALL_DOWNLOADS_CONTENT_URI(Context ctx) {
        return Uri.parse("content://" + DownloadProvider.getAuth(ctx) + "/all_downloads");
    }
