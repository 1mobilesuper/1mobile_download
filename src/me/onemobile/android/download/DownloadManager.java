...
/**
 * The download manager is a client service that handles long-running HTTP downloads. Clients may
...
public class DownloadManager {
    ...
    public static class Request {
       ...
       /* public Request setDestinationInExternalPublicDir(String dirType, String subPath) {
        ...
        ContentValues toContentValues(String packageName) {
    		...
    		values.put(Downloads.Impl.COLUMN_VISIBILITY, Downloads.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);//
    		values.put(Downloads.Impl.COLUMN_FILE_NAME_HINT,mUri.toString());
    		...
    		values.put(Downloads.Impl.COLUMN_NOTIFICATION_CLASS, DownloadReceiver.class.getName());
    ...
    private DownloadManager(Context ctx, ContentResolver resolver, String packageName) {
    	mResolver = resolver;
    	mPackageName = packageName;
    	mBaseUri = Downloads.get_CONTENT_URI(ctx);
    }
    
    public static DownloadManager getInstance(Context ctx, ContentResolver resolver, String packageName){
    	if(downloadManager == null){
    		downloadManager = new DownloadManager(ctx, resolver, packageName);
    	}
...
//    }
     ...
     */
    public long enqueue(Context ctx, Request request) {
		ContentValues values = request.toContentValues(mPackageName);
		Uri downloadUri = mResolver.insert(Downloads.get_CONTENT_URI(ctx), values);
