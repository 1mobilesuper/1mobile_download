...
class RealSystemFacade implements SystemFacade {
	...
	public Long getMaxBytesOverMobile() {
		try {
			return Settings.Secure.getLong(mContext.getContentResolver(), "download_manager_max_bytes_over_mobile");
	...
	public Long getRecommendedMaxBytesOverMobile() {
		try {
			return Settings.Secure.getLong(mContext.getContentResolver(), "download_manager_recommended_max_bytes_over_mobile");
		} catch (SettingNotFoundException exc) {
			return null;
		}
	}
	...
	public void cancelAllNotifications() {
		...
		// FIX ME needed?
		// ApplicationHelper.showPermanentNotification(mContext, false);
	}
